    ...
    return (
        <div className='-m-2 text-center mt-6'>
            ...
            <form>
                ...
                <button className=' inline-block mt-4 focus:outline-none text-white text-sm py-1 px-5 rounded-md bg-blue-500 hover:bg-blue-600 hover:shadow-lg ml-4'>Agregar</button>
